	...
	public function test_config() {
		...
		$this->assertEquals(
			...
			array(
				...
				'parent_item'                => 'Parent tour',
				'parent_item_colon'          => 'Parent tour:',
				'search_items'               => 'Search tours',
				'popular_items'              => 'Popular tours',
				'separate_items_with_commas' => 'Separate tours with commas',
				'add_or_remove_items'        => 'Add or remove tours',
				'choose_from_most_used'      => 'Choose from the most used tours',
