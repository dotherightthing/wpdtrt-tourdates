 ...
 * @version   1.0.0
 */
  define( 'WPDTRT_TOURDATES_VERSION', '1.0.12' );
}
 ...
 */
  ...
  function wpdtrt_tourdates_taxonomy_tour_init() {
    ...
    $wpdtrt_tourdates_taxonomy_tour = new DoTheRightThing\WPPlugin\r_1_4_15\Taxonomy(
      array(
  ...
  function wpdtrt_tourdates_shortcode_navigation_init() {
    ...
    $wpdtrt_tourdates_shortcode_navigation = new DoTheRightThing\WPPlugin\r_1_4_15\Shortcode(
      array(
  ...
  function wpdtrt_tourdates_shortcode_daynumber_init() {
    ...
    $wpdtrt_tourdates_shortcode_daynumber = new DoTheRightThing\WPPlugin\r_1_4_15\Shortcode(
      array(
  ...
  function wpdtrt_tourdates_shortcode_daytotal_init() {
    ...
    $wpdtrt_tourdates_shortcode_daytotal = new DoTheRightThing\WPPlugin\r_1_4_15\Shortcode(
      array(
  ...
  function wpdtrt_tourdates_shortcode_tourlengthdays_init() {
    ...
    $wpdtrt_tourdates_shortcode_tourlengthdays = new DoTheRightThing\WPPlugin\r_1_4_15\Shortcode(
      array(
  ...
  function wpdtrt_tourdates_shortcode_thumbnail_init() {
    ...
    $wpdtrt_tourdates_shortcode_thumbnail = new DoTheRightThing\WPPlugin\r_1_4_15\Shortcode(
      array(
  ...
  function wpdtrt_tourdates_shortcode_summary_init() {
    ...
    $wpdtrt_tourdates_shortcode_summary = new DoTheRightThing\WPPlugin\r_1_4_15\Shortcode(
      array(
