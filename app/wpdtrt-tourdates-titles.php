...
if ( !function_exists( 'wpdtrt_tourdates_post_title_add_day' ) ) {
  ...
  function wpdtrt_tourdates_post_title_add_day( $title, $id = NULL ) {
...
if ( !function_exists( 'wpdtrt_tourdates_attachment_title_remove_day' ) ) {

  function wpdtrt_tourdates_attachment_title_remove_day( $attachment_title = '', $fallback = '' ) {
...
if ( !function_exists( 'wpdtrt_tourdates_attachment_title_add_day' ) ) {

  function wpdtrt_tourdates_attachment_title_add_day( $attachment_title, $parent_title, $parent_id ) {
